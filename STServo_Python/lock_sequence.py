...
def rotate_st_continuous(sts_handler, sid=1, direction='f', speed=3000, rotations=2.0, abs_target=3000):
    sid = int(sid)
...
def perform_unlocking(sts_handler, sc_handler):
    ...
    print(f"\nStep 2: Servo 1 -> Continuous Rotation Backward Speed 3000, 2 Rollover Laps, Snap to 3000")
    rotate_st_continuous(sts_handler, 1, direction='b', speed=3000, rotations=2.0, abs_target=3000)
